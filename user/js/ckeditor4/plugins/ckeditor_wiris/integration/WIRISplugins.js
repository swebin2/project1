...
com.wiris.js.JsPluginViewer.prototype = {
	...
	,callService: function(mml,servicename) {
		...
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Calling: " + url,{ fileName : "JsPluginViewer.hx", lineNumber : 436, className : "com.wiris.js.JsPluginViewer", methodName : "callService"});
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("POST:" + data,{ fileName : "JsPluginViewer.hx", lineNumber : 438, className : "com.wiris.js.JsPluginViewer", methodName : "callService"});
	...
	,callCreateImage: function(mml,img) {
		...
		data += "&lang=" + this.lang;
		if(this.zoom != 1) data += "&zoom=" + this.zoom;
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Calling: " + url,{ fileName : "JsPluginViewer.hx", lineNumber : 367, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("POST:" + data,{ fileName : "JsPluginViewer.hx", lineNumber : 369, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
		con.open("POST",url,false);
		con.setRequestHeader("Content-type","application/x-www-form-urlencoded; charset=utf-8");
		con.send(data);
		...
		if(i >= 0) {
			...
			if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(h.get("formula"),{ fileName : "JsPluginViewer.hx", lineNumber : 392, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
		...
		if(height > 0) {
			if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(height - baseline,{ fileName : "JsPluginViewer.hx", lineNumber : 403, className : "com.wiris.js.JsPluginViewer", methodName : "callCreateImage"});
	...
	,processMathML: function(mml,container) {
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(mml,{ fileName : "JsPluginViewer.hx", lineNumber : 325, className : "com.wiris.js.JsPluginViewer", methodName : "processMathML"});
		var img = js.Lib.document.createElement("img");
		if(this.mode == com.wiris.js.JsPluginViewer.USE_CREATE_IMAGE) this.callCreateImage(mml,img); else img.src = this.baseURL + this.localpath + "/showimage" + this.extension + "?mml=" + StringTools.urlEncode(mml);
		container.appendChild(img);
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(img.src,{ fileName : "JsPluginViewer.hx", lineNumber : 333, className : "com.wiris.js.JsPluginViewer", methodName : "processMathML"});
	}
	...
	,replaceNodes: function(mathNodes,n) {
		...
		if(browser.getBrowser() == "Explorer" && (browser.getVersion() == "6" || browser.getVersion() == "7") && navigator.appVersion.indexOf("Trident") == -1) {
			if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Is ie7",{ fileName : "JsPluginViewer.hx", lineNumber : 224, className : "com.wiris.js.JsPluginViewer", methodName : "replaceNodes"});
	...
	,doLoad: function() {
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("doLoad",{ fileName : "JsPluginViewer.hx", lineNumber : 100, className : "com.wiris.js.JsPluginViewer", methodName : "doLoad"});
		...
		while(_g1 < _g) {
			...
			if(j >= 0) {
				...
				if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace(this.baseURL,{ fileName : "JsPluginViewer.hx", lineNumber : 119, className : "com.wiris.js.JsPluginViewer", methodName : "doLoad"});
			}
		}
		...
		this.ready = true;
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Tech:" + this.tech,{ fileName : "JsPluginViewer.hx", lineNumber : 150, className : "com.wiris.js.JsPluginViewer", methodName : "doLoad"});
		...
		if(com.wiris.js.JsPluginViewer.DEBUG) haxe.Log.trace("Language:" + this.lang,{ fileName : "JsPluginViewer.hx", lineNumber : 174, className : "com.wiris.js.JsPluginViewer", methodName : "doLoad"});
