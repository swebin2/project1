...
if(isset($_POST['Forgot']))
{
   ...
   $result     		= $objgen->get_Onerow("users","AND email='".$email."'");
   if($result['password']!="")
   {
	 
	 $mail = new PHPMailer();
						
	 $message = 'Dear '.$result['full_name'].',<br /><br />
		Email : '.$result['email'].' <br /><br />
		Password : '.$objgen->decrypt_pass($result['password']).' <br /><br />
		<a href="http://'.ROOT_PATH.'" >'.WEBSITE.'</a> is the online exams practises.<br /><br />
		...
		Team '.SITE_NAME.' <br />';
					...
					$mail->Subject = SITE_NAME." - Your Password";
					$mail->MsgHTML($message);
					$mail->Send();
					
		$msg2 = 'Your Password Sent to Email.';
   }
   else
   {
     $msg = 'Email not exist.';
...
<div class="layout-theme animated-css" data-header="sticky" data-header-top="200"> 
  ...
  <div id="wrapper"> 
    ...
    <button name="Forgot" type="submit" >
      <i class="spinner"></i>
      <span class="state">Send</span>
    </button>
