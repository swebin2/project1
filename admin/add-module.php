...
$pagehead = "Module";
$list_url = URLAD."module";
$add_url  = URLAD."add-module";

$page	 	= isset($_REQUEST['page'])	?	$_REQUEST['page']	:	"1";

if($_GET['msg']==1)
{
  $msg2 = "Module Created Successfully.";
}
...
if(isset($_POST['Create']))
{
   ...
   $rules		=	array();
   $rules[] 	= "required,name,Enter the Module";
   $errors  	= $objval->validateFields($_POST, $rules);
   
   $brd_exit = $objgen->chk_Ext("module","name='$name' and exam_id=$exam_id");
	if($brd_exit>0)
	{
		$errors[] = "This module is already exists.";
	}

   if(empty($errors))
	{
		 
		 $msg = $objgen->ins_Row('module','name,exam_id,code',"'".$name."','".$exam_id."','".$code."'");
		 if($msg=="")
		 {
...
if(isset($_GET['edit']))
{
       ...
       $id = $_GET['edit'];
	   $result   = $objgen->get_Onerow("module","AND id=".$id);
...
{    
   ...
   $brd_exit = $objgen->chk_Ext("module","name='$name' and exam_id=$exam_id and id<>$id");
	if($brd_exit>0)
	{
		$errors[] = "This module is already exists.";
	}
   ...
   if(empty($errors))
	{
	  ...
	  $msg = $objgen->upd_Row('module',"name='".$name."',exam_id='".$exam_id."',code='".$code."'","id=".$id);
	  if($msg=="")
	  {
                ...
                <form role="form" action="" method="post" enctype="multipart/form-data" >
                                   ...
                                   <div class="alert alert-danger alert-dismissable">
									...
									<div class="form-group">
									  <label for="input1" class="form-label">Module *</label>
