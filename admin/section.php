...
{
   $id= $_GET['del'];
   $msg     = $objgen->del_Row("section","id=".$id);
    if($msg=="")
   {
...
if($_GET['msg']==2)
{
  ...
  $msg2 = "Section Updated Successfully.";
}

if($_GET['msg']==3)
{

  $msg2 = "Section Deleted Successfully.";
}
...
$row_count = $objgen->get_AllRowscnt("section",$where);
if($row_count>0)
{
  ...
  $res_arr = $objgen->get_AllRows("section",$pagesize*($page-1),$pagesize,"id desc",$where);
}
										...
										if($row_count>0)
										{
										  foreach($res_arr as $key=>$val)
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?=$list_url?>/?del=<?=$val['id']?>&page=<?=$page?>" role="button" onClick="return confirm('Do you want to delete this Section?')"><span class="fa fa-trash-o"></span></a></td>
                                            </tr>
