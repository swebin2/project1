										  ...
										  foreach($res_arr as $key=>$val)
                                            ...
                                            <tr>
                                                <td><?php echo $objgen->check_tag($val['username']); ?></td>
                                                 <td><?php echo $objgen->check_tag($val['user_type']); ?></td>
                                                 <td><?php echo $objgen->check_tag($result['exam_name']); ?></td>
                                                <td><a href="<?=$add_url?>/?edit=<?=$val['admin_id']?>&page=<?=$page?>" role="button" ><span class="fa fa-edit"></span></a></td>
                                                <td>
												<?php
												if($val['status']=='active')
												{
												?>
												<a href="<?=$list_url?>/?id=<?=$val['admin_id']?>&page=<?=$page?>&st=<?php echo $val['status']; ?>" role="button" ><span class="fa fa-unlock"></span></a>
												<?php
												}
												else
												{
												?>
												<a href="<?=$list_url?>/?id=<?=$val['admin_id']?>&page=<?=$page?>&st=<?php echo $val['status']; ?>" role="button" ><span class="fa fa-lock"></span></a>
												<?php
												}
												?>
												</td>
