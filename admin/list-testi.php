...
{
   $id= $_GET['del'];
   $msg     = $objgen->del_Row("testimonials","id=".$id);
    if($msg=="")
   {
...
if($_GET['msg']==2)
{
  ...
  $msg2 = "Testimonial Updated Successfully.";
}

if($_GET['msg']==3)
{

  $msg2 = "Testimonial Deleted Successfully.";
}
...
{
  $un = trim($_REQUEST['un']);
  $where .= " and testimonial like '%".$un."%'";
}



$row_count = $objgen->get_AllRowscnt("testimonials",$where);
if($row_count>0)
{
  ...
  $res_arr = $objgen->get_AllRows("testimonials",$pagesize*($page-1),$pagesize,"id desc",$where);
}
            ...
            <div class="panel-body">
              <form class="form-inline" method="post" enctype="multipart/form-data" >
			    <div class="form-group">
                  <label class="form-label" for="example1">Testimonial</label>
                                     ...
                                     <table id="example1" class="table table-bordered table-striped">
										...
										if($row_count>0)
										{
										  foreach($res_arr as $key=>$val)
											...
											?>
                                            <tr>
                                                <td><?php echo $objgen->check_tag($val['testimonial']); ?></td>
                                                <td><?php echo $objgen->check_tag($val['author']); ?></td>
