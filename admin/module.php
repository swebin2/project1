...
{
   $id= $_GET['del'];
   $msg     = $objgen->del_Row("module","id=".$id);
    if($msg=="")
   {
...
if($_GET['msg']==2)
{
  ...
  $msg2 = "Module Updated Successfully.";
}

if($_GET['msg']==3)
{

  $msg2 = "Module Deleted Successfully.";
}
...
$row_count = $objgen->get_AllRowscnt("module",$where);
if($row_count>0)
{
  ...
  $res_arr = $objgen->get_AllRows("module",$pagesize*($page-1),$pagesize,"id desc",$where);
}
            ...
            <div class="panel-body">
              <form class="form-inline" method="post" enctype="multipart/form-data" >
			    <div class="form-group">
                  <label class="form-label" for="example1">Module</label>
										...
										if($row_count>0)
										{
										  foreach($res_arr as $key=>$val)
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="<?=$list_url?>/?del=<?=$val['id']?>&page=<?=$page?>" role="button" onClick="return confirm('Do you want to delete this Module?')"><span class="fa fa-trash-o"></span></a></td>
                                            </tr>
